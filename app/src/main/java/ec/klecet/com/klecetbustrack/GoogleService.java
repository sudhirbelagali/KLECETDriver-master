...
public class GoogleService extends Service implements LocationListener {
    ...
    public static String str_receiver = "ec.klecet.com.klecetbustrack.receiver";
    Intent intent;
...
//        fn_getlocation();
    ...
    private void fn_update(Location location) {
        //Toast.makeText(getApplicationContext(), "Updating Location, Sending Broadcast Intent",Toast.LENGTH_SHORT).show();
