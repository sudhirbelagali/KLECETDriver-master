...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myService = new Intent(MainActivity.this, GoogleService.class);
    ...
    private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            /*String taskId = "-L8LdJeJGMY7oEQFySii";

            mDatabase.child(taskId).child("latitude");
            mDatabase.setValue(latitude);

            mDatabase.child(taskId).child("longitude");
            mDatabase.setValue(latitude);*/
            String taskId = "-LCrW_vVifPCz4YhWtsK";
